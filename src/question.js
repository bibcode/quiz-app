const questions = [
    ...
    {
        questionText: "Which of the following planets is known as the Red Planet?",
        answerOptions: [
    ...
    {
        questionText: "Who is the founder of telegram",
        answerOptions: [
            { answerText: "Mark Zuckerberg", isCorrect: false },
            { answerText: "Pavel Durov", isCorrect: true },
